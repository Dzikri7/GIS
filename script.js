document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/Dzikri7/GIS/main/point.json") // Ganti "data.json" dengan nama file JSON Anda
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/Dzikri7/GIS/main/polygon.json") // Ganti "data.json" dengan nama file JSON Anda
        .then(response => response.json())
        .then(data => {
            data.features.forEach(feature => {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://raw.githubusercontent.com/Dzikri7/GIS/main/poliline.json") // Ganti "data.json" dengan nama file JSON Anda
        .then(response => response.json())
        .then(data => {
            data.features.forEach(feature => {
